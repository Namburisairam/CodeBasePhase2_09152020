...
namespace EventManagement.BusinessLogic.Business
{
    public class SurveyLogic : BaseLogic
    {
        ...
        public void SaveSurvey(int? surveyID,string surveyName, string surveyLevel, string surveyDescription, int? surveyEventID, int? surveyEventActivityID, int? surveyTemplate)
        {
        ...
        public void SaveSurveyQuestions(string surveyName,int? surveyTemplate)
        {
            ...
            foreach (var question in questions)
            {
                ...
                Db.SaveChanges();
                var TQID = Db.Questions.FirstOrDefault(x => x.QuestionText == question.TQuestionText && x.SurveyID == (int)surveyID).ID;
