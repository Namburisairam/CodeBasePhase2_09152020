...
namespace EventManagement.Areas.API.Controllers
{
    ...
    public class EventController : BaseAPIController
    {
        ...
        public async Task<ActionResult> GetEventById(string Token, int eventId)
        {
            ...
            authLogic.AddAttendeeBookMarksOfEvent(CurrentUserSession.Attende.Email, eventId);
            var eventData = await eventLogic.GetEventById(eventId);
            return Json(eventLogic.createEventAPIEntity(eventData, imageToUrlConvertionHandler, CurrentUserSession.AttendesID.Value, IsAdmin, imageConvertionHandler), JsonRequestBehavior.AllowGet);
        }
        ...
        //        {
        //            eventData.EventInfo.AboutEventDescription,
        //            eventData.EventInfo.AboutEventIcon,
        //            eventData.EventInfo.AboutEventTitle,
        //            eventData.EventInfo.AccomodationsDescription,
        //            eventData.EventInfo.AccomodationsIcon,
        //            eventData.EventInfo.AccomodationsTitle,
        //            eventData.EventInfo.ArrivalInfoDescription,
        //            eventData.EventInfo.ArrivalInfoIcon,
        //            eventData.EventInfo.ArrivalInfoTitle,
        //            eventData.EventInfo.EnableAboutEvent,
        //            eventData.EventInfo.EnableAccomodations,
        //            eventData.EventInfo.EnableAppHelpDesk,
        //            eventData.EventInfo.EnableArrivalInfo,
        //            eventData.EventInfo.EnableThingsToKnow,
        //            eventData.EventInfo.HelpDeskIcon,
        //            eventData.EventInfo.HelpDeskTitle,
        //            eventData.EventInfo.ID,
        //            eventData.EventInfo.ThingsToKnowDescription,
        //            eventData.EventInfo.ThingsToKnowIcon,
        //            eventData.EventInfo.ThingsToKnowTitle
        //        }
        ...
        /// <param name="eventId"></param>
        /// <returns></returns>
        public ActionResult GetAllDocuments(string Token, int eventId)
        {
            EventLogic eventLogic = new EventLogic();
            var allDocs = eventLogic.GetAllDocumentsExcludingImages(eventId, CurrentUserSession.AttendesID.Value);
        ...
        //public async Task<ActionResult> SurveyQuestionswithOptions(string Token, /*bool IsAtActvityLevel,*/bool IsAtEventLevel, bool IsAtAppLevel)
        //{
        //    EventLogic eventLogic = new EventLogic();
        //    var QWO = await eventLogic.QuestionswithOptions(/*IsAtActvityLevel,*/ IsAtEventLevel, IsAtAppLevel, CurrentUserSession.AttendesID.Value);
        ...
        public async Task<bool> SaveSurvey(string Token, Response[] SurveyResponse, int? EventID, int? ActivityID)
        {
            try
            {
                EventLogic eventLogic = new EventLogic();
                await eventLogic.AddNewSurvey(SurveyResponse, CurrentUserSession.AttendesID.Value, EventID, ActivityID);
